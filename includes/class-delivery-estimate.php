...
class MG_Delivery_Estimate {
    ...
    public static function render_tile() {
        ...
        $normal_date = self::add_business_days($settings['normal_days'], $settings['holidays'], $timezone);
        $express_date = self::add_business_days($settings['express_days'], $settings['holidays'], $timezone);
        $format = 'F j. l';
