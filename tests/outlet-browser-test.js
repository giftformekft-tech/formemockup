...
(async () => {
    ...
    try {
        ...
        assert.equal(await page.locator('#mg-outlet-price').inputValue(), '3990', 'outlet price defaults to 3990');
        ...
        assert.equal(requests[1].get('price'), '3990', 'default price is submitted without typing');
