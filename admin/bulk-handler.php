...
add_action('wp_ajax_mg_bulk_process_one', function(){
    ...
    try {
        ...
        $personalization_result = MG_Personalization_Import::apply_selection($product_id, $personalization_selection);
        if (is_wp_error($personalization_result)) wp_send_json_error(array('message' => $personalization_result->get_error_message()), 400);
