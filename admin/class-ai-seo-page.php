...
class MG_AI_SEO_Page {
    ...
    public static function render_print_settings() {
        ...
        echo '<tr><th scope="row">' . esc_html__('Kontúrhaló csökkentése', 'mockup-generator') . '</th><td>' . esc_html__('Kikapcsolva. A Design-flow peremjavítás nem fut az AI-nyomatokon.', 'mockup-generator') . '</td></tr></table>';
