                    ...
                    <tr>
                        ...
                        <td>
                            <select id="mg-gads-loser-basis" name="mg_gads_performance[loser_basis]">
                                ...
                                <option value="roas" <?php selected($settings['loser_basis'], 'roas'); ?>>Nullszaldós ROAS alapján (eltérő árú terméktípusokhoz)</option>
                            ...
                            <p><label>Nullszaldós ROAS: <input class="small-text" type="number" min="1" step="1" name="mg_gads_performance[loser_target_roas]" value="<?php echo !empty($settings['loser_target_roas']) ? esc_attr($settings['loser_target_roas']) : ''; ?>" placeholder="pl. 300"> %.</label></p>
                            <p class="description">ROAS módban az a konverziós érték / költés arány, amelynél a hirdetés éppen megtérül (például 33% árrésnél kb. 300%). A tesztkeret a lenti rögzített keret, de legalább az attribútált konverziós érték háromszorosa a nullszaldós ROAS-szal osztva. Így a termék akkor Loser, ha bevétel nélkül elérte a rögzített keretet, vagy a ROAS-a a nullszaldós érték harmadára esett. Mivel a konverziós értéket nézi, a drágább és olcsóbb terméktípusokat is arányosan kezeli.</p>
                            <p><label>Rögzített tesztkeret: legalább <input class="small-text" type="number" min="1" step="1" name="mg_gads_performance[loser_spend]" value="<?php echo esc_attr($settings['loser_spend']); ?>"> Ft költés.</label> Rögzített módban 0 eladással; ROAS módban ez a minimum tesztkeret.</p>
                            ...
                            <p class="description">Az első kattintástól vagy költéstől a konverziós késéssel lezárt napig számolunk. A kattintásszám önmagában nem okoz Loser státuszt. Mindhárom költségalapú szabályhoz HUF pénznemű Ads-fiók szükséges.</p>
                        </td>
                    </tr>
