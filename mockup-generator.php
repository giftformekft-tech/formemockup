...
add_action('load-toplevel_page_mockup-generator', function(){
    ...
    add_action('admin_enqueue_scripts', function($hook){
        if (strpos($hook, 'mockup-generator') !== false) {
            wp_enqueue_style('mg-admin', plugins_url('assets/css/admin.css', __FILE__), [], '1.2.8');
            wp_enqueue_script('mg-admin', plugins_url('assets/js/admin.js', __FILE__), ['jquery'], '1.2.8', true);
