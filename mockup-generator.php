...
if (!defined('MG_VERSION')) {
    define('MG_VERSION', '2.38.9');
}

register_deactivation_hook(__FILE__, function () {
    wp_clear_scheduled_hook('mg_openai_feeds_daily_refresh');
});
...
add_action('plugins_loaded', function(){
    ...
    // SAFE includes
    $files = [
        'includes/class-outlet.php',
        'includes/class-bulk-batch.php',
        ...
        'admin/class-gift-finder-transfer.php',
    ...
    if (class_exists('MG_Category_Popup')) {
        MG_Category_Popup::init();
    }
    ...
    if (class_exists('MG_Gift_Finder_Transfer')) {
        MG_Gift_Finder_Transfer::init();
    }
    ...
    if (class_exists('MG_Analytics_Price_Fix')) {
        MG_Analytics_Price_Fix::init();
    }
